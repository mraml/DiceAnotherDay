...
1.  * 3d6 to track Infection Rate, Hope, and Cure Progress.
2.  * d20 to roll for Action & the Infection phases

**Setup:**

1.  **Threat Level:** Choose a disease severity level (this affects the starting Infection Rate):
...
3.  **Hope:** Start with a Hope Level of 6. This represents global morale and resources.
4.  **Cure Progress:** Start at 0. You need to reach a Cure Level of 3 to win.
...
2.  **Infection Phase:** Roll 1d20. The outcome depends on the current Infection Rate:
    ...
    * **Infection Rate 3+:**
        ...
        * 4-10: Major outbreak. Decrease Hope Level by 3.
...
* **Event Rolls:** At the start of each round, roll a separate d6. Consult the Event Table:
        * 1-2: New research funding increases Hope by 1
        * 3-4: Radio silence. No news is good news.
        * 5-6: Supply chain disruption decreases Hope by 2
...
* **Hardcore Mode:** If you roll a 1 in the Action Phase or a 20 in the Infection Phase, your Cure Level is reset to 0.
