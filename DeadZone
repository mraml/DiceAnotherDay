...
### Critical Hit
If you roll a natural 20 on an attack, you execute a critical hit and deal double damage.
...
## Difficulty Variants
- **Prepper Mode**: Start with Combat Skill 2, Armor 1
- **Hardcore Mode**: No Last Stand ability, Zombies can also roll critical hits
- **Nightmare Mode**: Hardcore, plus Zombie threat levels are zone number + 2
